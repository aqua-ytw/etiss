...
if (imm) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd + 8U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[2U] + " + std::to_string(imm) + "U;\n";
}
else {
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "etiss_uint32 load_address = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] + " + std::to_string(uimm) + "U;\n";
...
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
cp.code() += "}\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd + 8U) + "U] = (etiss_int32)(mem_val_0);\n";
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "etiss_uint32 load_address = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] + " + std::to_string(uimm) + "U;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 + 8U) + "U]);\n";
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rs1 % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[1U] = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string(((etiss_int32)((imm) << (14)) >> (14))) + ";\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if (nzimm) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[2U] = *((RV32IMACFDXCoreV*)cpu)->X[2U] + " + std::to_string(((etiss_int16)((nzimm) << (6)) >> (6))) + ";\n";
}
else {
cp.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 2U);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] >> " + std::to_string(shamt) + "U;\n";
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rs1 + 8U], 32);
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if (shamt) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] = ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U])) >> " + std::to_string(shamt) + "U;\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] & " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getRegisterDependencies().add(reg_name[rs1 + 8U], 32);
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd + 8U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd + 8U) + "U] - *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 + 8U) + "U];\n";
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "if (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] == 0U) {\n";
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if (nzuimm) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] << " + std::to_string(nzuimm) + "U;\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if (rd % 32U) {
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "cpu->exception |= (*(system->dread))(system->handle, cpu, *((RV32IMACFDXCoreV*)cpu)->X[2U] + " + std::to_string(uimm) + "U, (etiss_uint8*)&mem_val_0, 4);\n";
cp.code() += "if (cpu->exception) {\n";
cp.code() += "translate_exc_code(cpu, system, plugin_pointers, cpu->exception);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
cp.code() += "}\n";
cp.code() += "etiss_int32 res = mem_val_0;\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_int32)(res);\n";
}
else {
cp.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 2U);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U];\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if (rs1) {
cp.code() += "cpu->nextPc = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] & -2;\n";
}
else {
cp.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 2U);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] + *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U];\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "etiss_uint32 new_pc = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U];\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[1U] = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCoreV*)cpu)->X[2U] + " + std::to_string(uimm) + "U;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]);\n";
