...
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string((etiss_uint32)(((etiss_int32)(imm)))) + "U;\n";
}
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string(ic.current_address_ + (etiss_int32)(imm)) + ";\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
}
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
cp.code() += "etiss_uint32 new_pc = (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ") & -2;\n";
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
cp.code() += "if (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] == *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]) {\n";
if (imm % 2U) {
cp.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 0U);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
}
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
cp.code() += "if ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]) < (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U])) {\n";
if (imm % 2U) {
cp.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 0U);\n";
cp.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
}
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
cp.code() += "etiss_uint32 load_address = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
cp.code() += "etiss_uint32 store_address = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
cp.code() += "etiss_uint8 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int8)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]);\n";
...
cp.code() += "etiss_uint32 store_address = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
cp.code() += "etiss_uint16 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int16)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]);\n";
...
cp.code() += "etiss_uint32 store_address = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]);\n";
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ";\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]) < " + std::to_string(((etiss_int16)((imm) << (4)) >> (4))) + ")) ? (1U) : (0U);\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = ((*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] < " + std::to_string((etiss_uint32)((((etiss_int16)((imm) << (4)) >> (4))))) + "U)) ? (1U) : (0U);\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] ^ " + std::to_string((etiss_uint32)((((etiss_int16)((imm) << (4)) >> (4))))) + "U;\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] << " + std::to_string(shamt) + "U;\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]) >> " + std::to_string(shamt) + "U;\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] << (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U] & 31U);\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = ((etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]) < (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U])) ? (1U) : (0U);\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] < *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U]) ? (1U) : (0U);\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
if ((rd % 32U) != 0U) {
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_int32)(*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 % 32U) + "U]) >> (*((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs2 % 32U) + "U] & 31U);\n";
}
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
cp.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 4U) + "U;\n";
cp.code() += "((RV32IMACFDXCoreV*)cpu)->FENCE[0U] = " + std::to_string(pred << 4U | succ) + "U;\n";
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
		cp.getAffectedRegisters().add("instructionPointer", 32);
