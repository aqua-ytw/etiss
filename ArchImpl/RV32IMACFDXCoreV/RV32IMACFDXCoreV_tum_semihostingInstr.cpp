...
cp.code() += "etiss_uint32 operation = *((RV32IMACFDXCoreV*)cpu)->X[10U];\n";
cp.code() += "etiss_uint32 parameter = *((RV32IMACFDXCoreV*)cpu)->X[11U];\n";
cp.code() += "*((RV32IMACFDXCoreV*)cpu)->X[10U] = (etiss_int32)(etiss_semihost(cpu, system, plugin_pointers, 32U, operation, parameter));\n";
cp.code() += "}\n";
cp.code() += "else {\n";
