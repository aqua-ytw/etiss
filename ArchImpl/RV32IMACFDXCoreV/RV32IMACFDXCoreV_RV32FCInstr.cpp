...
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] + " + std::to_string(uimm) + "U;\n";
...
cp.code() += "((RV32IMACFDXCoreV*)cpu)->F[" + std::to_string(rd + 8U) + "U] = -4294967296L | res;\n";
...
cp.code() += "etiss_uint32 offs = *((RV32IMACFDXCoreV*)cpu)->X[" + std::to_string(rs1 + 8U) + "U] + " + std::to_string(uimm) + "U;\n";
cp.code() += "etiss_uint32 mem_val_0;\n";
cp.code() += "mem_val_0 = (etiss_uint32)(((RV32IMACFDXCoreV*)cpu)->F[" + std::to_string(rs2 + 8U) + "U]);\n";
