...
{
return (*((RV32IMACFDXCoreV*)cpu)->CSR[769] >> (extension - 65U)) & 1U;
}
#endif
...
if (((RV32IMACFDXCoreV*)cpu)->PRIV <= 1 && (*((RV32IMACFDXCoreV*)cpu)->CSR[770] >> mcause) & 1U) {
cpu->nextPc = (*((RV32IMACFDXCoreV*)cpu)->CSR[261] & -2);
*((RV32IMACFDXCoreV*)cpu)->CSR[321] = epc;
*((RV32IMACFDXCoreV*)cpu)->CSR[322] = mcause;
etiss_uint32 s = *((RV32IMACFDXCoreV*)cpu)->CSR[256];
s = set_field(s, 32, get_field(s, 2));
s = set_field(s, 256, ((RV32IMACFDXCoreV*)cpu)->PRIV);
s = set_field(s, 2, 0U);
*((RV32IMACFDXCoreV*)cpu)->CSR[256] = s;
((RV32IMACFDXCoreV*)cpu)->PRIV = (1) & 0x7;
}
else {
cpu->nextPc = (*((RV32IMACFDXCoreV*)cpu)->CSR[773] & -2);
*((RV32IMACFDXCoreV*)cpu)->CSR[833] = epc;
*((RV32IMACFDXCoreV*)cpu)->CSR[834] = mcause;
etiss_uint32 s = *((RV32IMACFDXCoreV*)cpu)->CSR[768];
s = set_field(s, 128, get_field(s, 8));
s = set_field(s, 6144, ((RV32IMACFDXCoreV*)cpu)->PRIV);
s = set_field(s, 8, 0U);
*((RV32IMACFDXCoreV*)cpu)->CSR[768] = s;
((RV32IMACFDXCoreV*)cpu)->PRIV = (3) & 0x7;
}
}
#endif
...
if (1U && get_field(*((RV32IMACFDXCoreV*)cpu)->CSR[384], 2147483648U) || 0U && get_field(*((RV32IMACFDXCoreV*)cpu)->CSR[384], 17293822569102704640UL)) {
mask = mask | 262144;
}
}
return mask;
...
{
if (csr == 1) {
return *((RV32IMACFDXCoreV*)cpu)->CSR[3] & 31U;
}
if (csr == 2) {
return (*((RV32IMACFDXCoreV*)cpu)->CSR[3] >> 5U) & 7U;
}
if (csr == 3072) {
...
if (csr == 768 || csr == 256) {
return *((RV32IMACFDXCoreV*)cpu)->CSR[768] | 8589934592UL | 34359738368UL;
}
if (csr == 769) {
return (((1U) << 31) | ((((*((RV32IMACFDXCoreV*)cpu)->CSR[769]) >> (0U)) & 2147483647)));
}
...
{
if (csr == 1) {
*((RV32IMACFDXCoreV*)cpu)->CSR[3] = (*((RV32IMACFDXCoreV*)cpu)->CSR[3] & 224U) | (val & 31U);
}
 else if (csr == 2) {
*((RV32IMACFDXCoreV*)cpu)->CSR[3] = ((val & 7U) << 5U) | (*((RV32IMACFDXCoreV*)cpu)->CSR[3] & 31U);
}
 else if (csr == 3) {
*((RV32IMACFDXCoreV*)cpu)->CSR[3] = val & 255U;
}
 else if (csr == 768) {
*((RV32IMACFDXCoreV*)cpu)->CSR[768] = val & mstatus_mask(cpu, system, plugin_pointers);
}
 else if (csr == 256) {
*((RV32IMACFDXCoreV*)cpu)->CSR[768] = val & sstatus_mask(cpu, system, plugin_pointers);
}
 else if (csr != 769) {
